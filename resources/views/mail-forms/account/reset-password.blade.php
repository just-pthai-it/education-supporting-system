      ...
      <table style="border-collapse: collapse; width: 600px; margin: auto; border: 1px solid #dddddd;">
        ...
        <tr class="body">
          <td style="padding: 1rem; padding-top: 1.5rem !important; padding-bottom: 1.5rem !important;">
            <p>
              Xin chào {{ $name }},<br />
              Bạn đã yêu cầu đặt lại mật khẩu. Hãy truy cập vào đường link phía dưới để đặt lại mật khẩu:<br />
            </p>
            <p><a href="{{$url}}" style="color: #04af04; font-size: 15px; text-decoration: none;">Đặt lại mật khẩu</a></p>
            <p>Nếu không phải là bạn đã yêu cầu đặt lại mật khẩu, hãy bỏ qua email này.</p>
            <p>Trân trọng.</p>
            <div style="margin-top: 0.25rem; font-weight: bold; font-style: italic; color: #04af04;">Đội ngũ phát triển UTCKetnoi</div>
          </td>
        </tr>
        <tr class="footer">
